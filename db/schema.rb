...
ActiveRecord::Schema[7.0].define(version: 2023_09_30_203855) do
  ...
  create_table "albums_artists", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_albums_artists_on_user_id"
  end
  ...
  create_table "artists_songs", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_artists_songs_on_user_id"
  end
  ...
  add_foreign_key "albums_artists", "users"
  add_foreign_key "artists_songs", "songs", on_update: :nullify, on_delete: :nullify
  add_foreign_key "artists_songs", "users"
