...
class PlaylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create playlist" do
    assert_difference("Playlist.count") do
      post playlists_url, params: { playlist: { cover_image: @playlist.cover_image, name: @playlist.name, privacy: @playlist.privacy } }
    end
  ...
  test "should update playlist" do
    patch playlist_url(@playlist), params: { playlist: { cover_image: @playlist.cover_image, name: @playlist.name, privacy: @playlist.privacy } }
